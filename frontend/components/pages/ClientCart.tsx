...
//
// const ClientCart = ({ items }: { items: ICartItem[] }) => {
...
//   };
//
//   const calculateTotalAmount = (products: ICartItem[]) => {
//     let totalAmount = 0;
//
...
//                   <span className={"font-semibold text-4xl"}>$ {calculateTotalAmount(selectedProducts)}</span>
//                 </div>
//               </div>
//
